...
def show_getting_started() -> None:
    ...
    print()
    print("   # Required - choose based on your preferred model:")
    print(f"   export ANTHROPIC_API_KEY='sk-ant-...'")
    print(f"     → Get key: {API_KEYS['anthropic']['url']}")
    print()
    print("   # Recommended - for better web search:")
    print(f"   export BRAVE_SEARCH_API_KEY='BSA...'")
    print(f"     → Get free key: {API_KEYS['brave']['url']}")
    print()
    print("2. Create a project directory:")
    print("   mkdir ~/my-project && cd ~/my-project")
    print()
    print("3. Run sciagent:")
    print("   sciagent 'Create a Python script that fetches weather data'")
    print()
    print("4. Or use interactive mode for multi-turn conversations:")
